...
const LavalinkCT1 = new Discord.Lavalink(client1);
LavalinkCT1.addNode({
    url: "lava.link:80",
    password: "lavalink",
    name: "UMC",
...
const LavalinkCT2 = new Discord.Lavalink(client2);
LavalinkCT2.addNode({
    url: "lava.link:80",
    password: "lavalink",
    name: "UMC",
...
const LavalinkCT3 = new Discord.Lavalink(client3);
LavalinkCT3.addNode({
    url: "lava.link:80",
    password: "lavalink",
    name: "UMC",
...
const LavalinkCT4 = new Discord.Lavalink(client4);
LavalinkCT4.addNode({
    url: "lava.link:80",
    password: "lavalink",
    name: "UMC",
...
const LavalinkCT5 = new Discord.Lavalink(client5);
LavalinkCT5.addNode({
    url: "lava.link:80",
    password: "lavalink",
    name: "UMC",
...
const clientloader_1 = new Discord.LoadCommands(client1);
clientloader_1.load(client1.cmd,'./Commands/C1/') 
const clientloader_2 = new Discord.LoadCommands(client2);
clientloader_2.load(client2.cmd,'./Commands/C2/') 
const clientloader_3 = new Discord.LoadCommands(client3);
clientloader_3.load(client3.cmd,'./Commands/C3/') 
const clientloader_4 = new Discord.LoadCommands(client4);
clientloader_4.load(client4.cmd,'./Commands/C4/') 
const clientloader_5 = new Discord.LoadCommands(client5);
