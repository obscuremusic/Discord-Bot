...
$description[1;**[Preview Link]($jsonRequest[https://is.gd/create.php?format=json&url=$message[1]&shorturl=$toLowercase[$message[2]];shorturl]) | [Original Link]($message[1]) | [Short-link Service](https://is.gd)**]
