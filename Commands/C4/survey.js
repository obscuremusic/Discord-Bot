...
$onlyPerms[manageserver;> :information_source: **You don't have enough permissions.**]`
  ...
  $wait[1s]
  $newTicket[➥・［⎋］﹕$username[$authorID]．;{execute:intro_vd};$getServerVar[verifycategory];no;]
  $cooldown[10s]`
},{
  name: "intro_vd",
  type: 'awaited',
  code:`$channelSendMessage[$findChannel[➥・［⎋］﹕$username[$findMember[$message[1]]]．;yes];test;no]`
}]
