module.exports = [{
  ...
  $author[1;$username joined.;https://cdn.discordapp.com/attachments/889976693102628904/922213724863987732/add-user.png]
  $addFields[1;Username:\`\`\`kt\n$username#$discriminator\`\`\`:yes;User ID:\`\`\`kt\n$authorID\`\`\`:yes]
  ...
  type:"leave",
  code:`$thumbnail[1;$authorAvatar]
  $author[1;$username left.;https://cdn.discordapp.com/attachments/889976693102628904/922213725090492456/remove-user.png]
  $addFields[1;Username:\`\`\`kt\n$username#$discriminator\`\`\`:yes;User ID:\`\`\`kt\n$authorID\`\`\`:yes]
